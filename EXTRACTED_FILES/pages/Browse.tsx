...
const BrowsePage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-8 animate-fade-in">
      ...
      <h1 className="text-4xl font-bold text-foreground mb-8">Browse</h1>
      ...
      {/* Discover Artists */}
      <section className="mb-10">
        <SectionHeader title="Discover artists" showAll allLink="/artists" />
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {mockArtists.slice(0, 5).map((artist) => (
            <MediaCard
              key={artist.id}
      ...
      {/* New Releases */}
      <section className="mb-10">
        <SectionHeader title="New Releases" showAll allLink="/albums" />
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
